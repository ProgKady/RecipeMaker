...
public class Preview implements Initializable {
   ...
   public void initialize(URL url, ResourceBundle rb) {
       ...
       /////////////////////////////////////////////////////////////////////////////
        ...
        bosbos2=RecipeMakerController_1.bosboss;
        String newpathyyy=bosbos2.replace(".ks", ".html");
        String linett = "cmd /C copy /Y "+bosbos2+" "+newpathyyy;
        Process pp;
        
          try {
              pp = Runtime.getRuntime().exec(linett);
              pp.waitFor();
        ...
        URI urii = Paths.get(bosbos2).toAbsolutePath().toUri();
        webview.getEngine().load(urii.toString());
        File nmm=new File (newpathyyy);
        if (bosbos2.contains(".ks")) {
            nmm.delete();
        }
        else {

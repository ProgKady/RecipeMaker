...
TableFilter filter = new TableFilter(datatable);
     ...
     @FXML
    void protypesaction(ActionEvent event) {
        ...
        try {
            // SQL query to join Recipe_Processes and Recipe_Types based on Model and WashName
            String sql = "SELECT rp.Model, rp.WashName, rp.Processes, rt.Rinse, rt.Stone, rt.Foam, rt.Bleach, rt.Enzyme, " +
                         "rt.MoonWash, rt.Dryer_1, rt.Dryer_2, rt.Dryer_3 " +
                         "FROM Recipe_Processes rp " +
                         "INNER JOIN Recipe_Types rt ON rp.Model = rt.Model AND rp.WashName = rt.WashName";

...
public class CopyARecipeController implements Initializable {
  ...
  /////////////////////////////////////////////////////////////////////////
    ...
    src.setText(pathy);
    des.setText(newpath);
    namef.setText(nameee+"_NEW_COPY");
    ...
    stage.getSelectionModel().select(stog);
    stage.hide();
      ...
      noti.showError();
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
         ...
         String sqla = "INSERT INTO notifications (Recipient, Sender, Message, Delivered) VALUES (?, ?, ?, 0)";
          ...
          pst.setString(3, "We have copied "+filenamet+" successfully in "+value1+" of "+modell+" model in "+stagee);
          pst.executeUpdate();
          }
          catch (Exception e) {
          } finally {

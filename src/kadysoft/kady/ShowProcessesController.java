 ...
 * @author KADY
 */
public class ShowProcessesController implements Initializable {
    ...
    void deleteaction(ActionEvent event) throws FileNotFoundException, IOException {
        ...
        Sheet spreadsheet = workbook.createSheet("Kadysoft_Recipe_Processes");
        ...
        dialog.setInitialFileName("Kadysoft_Recipe_Processes");

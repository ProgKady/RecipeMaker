 ...
 * @author KADY
 */
public class ShowTypesController implements Initializable {
    ...
    void deleteaction(ActionEvent event) throws FileNotFoundException, IOException {
        ...
        Sheet spreadsheet = workbook.createSheet("Kadysoft_Recipe_Types");
        ...
        dialog.setInitialFileName("Kadysoft_Recipe_Types");

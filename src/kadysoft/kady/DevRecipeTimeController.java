 ...
 * @author KADY
 */
public class DevRecipeTimeController implements Initializable {
...
alert.setTitle("Development Recipes Time");
alert.setHeaderText("Development Recipe Time Viewer");
alert.setContentText("Choose one option to view development recipes time: ");
